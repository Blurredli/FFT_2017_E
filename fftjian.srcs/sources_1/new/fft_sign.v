...
always @(posedge clk or negedge rst_n) begin
    ...
    else if (amp_d < 50) // 这里的51是根据实际情况调整的阈值
    begin
        amp_d_signed <= amp_d[7:0]; //>>> 1; // 更新幅度
    end
end

wire [7:0] amp_d_signed_avg;

assign amp_d_signed_avg = amp_d_signed;
// // 50次滑动平均输出
// reg [15:0] amp_sum = 0;
// reg [5:0] amp_cnt = 0;
...
assign A  = mult_full [14:7] + 8'd128;    // 居中输出
